...
export default function Main() {
  ...
  const firstScore =
    parseFloat(getScores(vitalKeywords, resume)).toFixed(2) || 0
  const secondScore =
    parseFloat(getScores(vitalSoftSkills, resume)).toFixed(2) || 0
  const thirdScore =
    parseFloat(getScores(jobRepeatPosting, resume)).toFixed(2) || 0
  ...
  return (
    <>
          ...
          <form id='main_form'>
            <div class='job-area'>
              ...
              <form class='job-upload'>
                <label for='myFile'>Upload a job</label>
                <input
                  type='file'
                  id='myFile'
                  name='filename'
            ...
            <div class='resume-area'>
              ...
              <form class='resume-upload'>
                <label for='myFile'>Upload a Resume</label>
                <input
                  type='file'
                  id='myFile'
                  name='filename'
      ...
      {submitState ? (
              ...
              <div className='job_search_container'>
                <div className='location_dropdown'>
                  <select onChange={onClick_JobSearch}>
                    <option className='location_option' value='location'>
                      Choose location
                    </option>
                ...
                <div className='job_search_button'>
                  <button
                    className='actual_jobSearch_button'
                    onClick={moveToJobSearch}
                  >
                    Job Search
                  </button>
                </div>
        ...
        <div className='please_input'>
          Please paste or upload a job posting and your resume.
        </div>
      )}
    </>
  )
